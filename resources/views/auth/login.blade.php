...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .form-label{font-size:12px;font-weight:500;color:var(--brown-800);display:block;margin-bottom:6px;letter-spacing:.3px;}
        ...
        .form-check input{accent-color:var(--brown-600);}
        ...
        .register-btn{display:block;width:100%;text-align:center;background:transparent;color:var(--brown-700);border:1px solid var(--brown-300);padding:12px;border-radius:4px;font-size:13px;font-weight:500;letter-spacing:1px;text-transform:uppercase;text-decoration:none;transition:all .2s;}
        .register-btn:hover{border-color:var(--brown-600);color:var(--brown-800);}
        .forgot-link{display:block;text-align:center;font-size:12px;color:var(--text-light);text-decoration:none;margin-top:14px;transition:color .2s;}
        .forgot-link:hover{color:var(--brown-700);}
    </style>
</head>
<body>
...
<div class="card">
    ...
    <a href="{{ route('register') }}" class="register-btn">Daftar Sekarang</a>
